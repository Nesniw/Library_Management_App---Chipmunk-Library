...
public class PilihBuku extends AppCompatActivity {
    ...
    private void displayData() {
        String url = AppConfig.IP_SERVER + "/Volley_perpus/view_data_pilihbuku.php";

        StringRequest strReq = new StringRequest(Request.Method.GET, url, responses -> {
            productList.clear();
            try {
                JSONObject jsonObj = new JSONObject(responses);
                Toast.makeText(PilihBuku.this, jsonObj.getString("message"), Toast.LENGTH_SHORT).show();
            ...
            recyclerView.setAdapter(new AdapterPilihBuku(PilihBuku.this, productList));
